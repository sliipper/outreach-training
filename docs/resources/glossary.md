...
## R
### RICH
Stands for 'Ring Imaging Cherenkov Detector'. Similar to a plane travelling faster than the speed of sound causing a 'sonic boom', a charged particle travelling through material faster than light can travel in that material will produce a cone of light, which we see as rings in our detectors. The detector uses mirrors to *** and the photos are collected by XXXX (link to later glossary item?)
